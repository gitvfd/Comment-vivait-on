  ...
  d3.tsv("data/Total_CO2_Emissions.tsv", function(tsv) {
    ...
    chartCO2.selectAll("circle")
      .on("mouseout",function(d) {
        ...
        document.getElementById("DQ_CO2").innerHTML= "Passez votre souris sur un pays pour obtenir des informations sur la qualité des données disponibles (de 1 = excellente qualité à 4 = estimation).";
