  ...
  d3.tsv("data/GDP_Per_Capita-WB.tsv", function(tsv) {
    ...
    chartGDP.selectAll("circle")
      .on("mouseout",function(d) {
        ...
        document.getElementById("DQ_GDP").innerHTML= "Passez votre souris sur un pays pour obtenir des informations sur la qualité des données disponibles (de 1 = excellente qualité à 4 = estimation).";
