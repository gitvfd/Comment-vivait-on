  ...
  d3.tsv("data/Labourers-Real-Wage-WB.tsv", function(tsv) {
    ...
    chartRealWages.selectAll("circle")
      .on("mouseout",function(d) {
        ...
        document.getElementById("DQ_WAGE").innerHTML= "Passez votre souris sur un pays pour obtenir des informations sur la qualité des données disponibles (de 1 = excellente qualité à 4 = estimation).";
