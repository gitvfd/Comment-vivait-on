  ...
  d3.tsv("data/Income_inequality-WB.tsv", function(tsv) {
    ...
    chartIncomeIneq.selectAll("circle")
      .on("mouseout",function(d) {
        ...
        document.getElementById("DQ_INCOMEINEQ").innerHTML= "Passez votre souris sur un pays pour obtenir des informations sur la qualité des données disponibles (de 1 = excellente qualité à 4 = estimation).";
