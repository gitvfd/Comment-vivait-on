  ...
  d3.tsv("data/Average_Years_of_Education-WB.tsv", function(tsv) {
    ...
    chartEducation.selectAll("circle")
      .on("mouseout",function(d) {
        ...
        document.getElementById("DQ_EDU").innerHTML= "Passez votre souris sur un pays pour obtenir des informations sur la qualité des données disponibles (de 1 = excellente qualité à 4 = estimation).";
