  ...
  d3.tsv("data/Life_Expectancy_at_Birth-WB.tsv", function(tsv) {
    ...
    chartLifeExp.selectAll("circle")
      .on("mouseout",function(d) {
        ...
        document.getElementById("DQ_LIFEEXP").innerHTML= "Passez votre souris sur un pays pour obtenir des informations sur la qualité des données disponibles (de 1 = excellente qualité à 4 = estimation).";
