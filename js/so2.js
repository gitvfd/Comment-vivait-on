  ...
  d3.tsv("data/Total_SO2_Emissions.tsv", function(tsv) {
    ...
    chartSO2.selectAll("circle")
      .on("mouseout",function(d) {
        ...
        document.getElementById("DQ_SO2").innerHTML= "Passez votre souris sur un pays pour obtenir des informations sur la qualité des données disponibles (de 1 = excellente qualité à 4 = estimation).";
