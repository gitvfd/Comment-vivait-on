  ...
  d3.tsv("data/Homicide_rates-WB.tsv", function(tsv) {
    ...
    chartHomicide.selectAll("circle")
      .on("mouseout",function(d) {
        ...
        document.getElementById("DQ_HOMICIDE").innerHTML= "Passez votre souris sur un pays pour obtenir des informations sur la qualité des données disponibles (de 1 = excellente qualité à 4 = estimation).";
