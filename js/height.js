  ...
  d3.tsv("data/Height-WB.tsv", function(tsv) {
    ...
    chartHeight.selectAll("circle")
      .on("mouseout",function(d) {
        ...
        document.getElementById("DQ_HEIGHT").innerHTML= "Passez votre souris sur un pays pour obtenir des informations sur la qualité des données disponibles (de 1 = excellente qualité à 4 = estimation).";
