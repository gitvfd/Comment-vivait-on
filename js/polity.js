  ...
  d3.tsv("data/Polity2_Index-WB.tsv", function(tsv) {
    ...
    chartPolity.selectAll("circle")
      .on("mouseout",function(d) {
        ...
        document.getElementById("DQ_POLITY").innerHTML= "Passez votre souris sur un pays pour obtenir des informations sur la qualité des données disponibles (de 1 = excellente qualité à 4 = estimation).";
