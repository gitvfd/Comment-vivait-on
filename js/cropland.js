  ...
  d3.tsv("data/Total_Pasture.tsv", function(tsv) {
    ...
    chartCropland.selectAll("circle")
      .on("mouseout",function(d) {
        ...
        document.getElementById("DQ_CROPLAND").innerHTML= "Passez votre souris sur un pays pour obtenir des informations sur la qualité des données disponibles (de 1 = excellente qualité à 4 = estimation).";
